...
public sealed class PageLayout : NotifyBase
{
    ...
    {
        get => name;
        set => SetField(ref name, string.IsNullOrWhiteSpace(value) ? name : value.Trim());
    }
}
...
public sealed class PagePlotElement : NotifyBase
{
    ...
    {
        get => x;
        set => SetField(ref x, Math.Round(value, 1));
    }

    public double Y
    {
        get => y;
        set => SetField(ref y, Math.Round(value, 1));
    }

    public double Size
    {
        get => size;
        set => SetField(ref size, Math.Round(Math.Clamp(value, 120, 640), 1));
    }
    ...
    {
        get => plot_mode;
        set => SetField(ref plot_mode, value);
    }
    ...
    public bool ShowTickLabels
    {
        ...
        set => SetField(ref show_tick_labels, value);
    }
    ...
    {
        get => show_gates;
        set => SetField(ref show_gates, value);
    }
