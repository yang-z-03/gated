...
namespace gated.Reduction
{
    internal static class Heaps
    {
        ...
        /// </summary>
        public static Heap BuildCandidates(Heap currentGraph, int n_vertices, int nNeighbors, int maxCandidates, IProvideRandomValues random)
        {
            var candidateNeighbors = MakeHeap(n_vertices, maxCandidates);
        ...
        public sealed class Heap
        {
            ...
            public Heap() => values = new List<float[][]>();

            public float[][] this[int index] { get => values[index]; }
